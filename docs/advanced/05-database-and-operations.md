...
Debrid-account magnets are retained only as bounded account snapshots. They are
matched against the current request and expire through the configured snapshot
TTL; no media association is persisted in the public release repository.
